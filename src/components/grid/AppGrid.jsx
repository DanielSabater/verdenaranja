  ...
  return (
    <div className="grid-scroll" style={{ overflowX:"auto", padding:"16px 8px 36px", WebkitOverflowScrolling:"touch" }}>
      <table style={{ borderCollapse:"collapse", tableLayout:"fixed", width:"100%", minWidth: isMobile ? `${professionals.length*80}px` : `${professionals.length*140}px` }}>
        ...
        <tbody>
          {HOURS.map((hour, hIdx) => (
            <tr key={hour} style={{ background: hIdx%2===0?C.white:C.cream, height:110 }}>
                ...
                return (
                  ...
                  >
                    {appt ? (() => {
                      ...
                      <div style={{ height:104, borderRadius:7, display:"flex", alignItems:"center", justifyContent:"center", color: isTarget && dropValid ? C.green : (isTarget ? "#e06060" : C.textSoft), fontSize: isTarget ? 22 : 10, letterSpacing:"0.5px", transition:"all .12s" }}>
